...
import com.example.app.views.masterdetail.MasterDetailView;
import com.example.app.views.map.MapView;
import com.example.app.views.personform.PersonFormView;
import com.example.app.views.addressform.AddressFormView;
import com.example.app.views.imagelist.ImageListView;
import com.example.app.views.creditcardform.CreditCardFormView;
 ...
 */
@PWA(name = "Vaadin 14 app", shortName = "Vaadin 14 app", enableInstallPrompt = false)
@Theme(themeFolder = "vaadin14app")
@PageTitle("Main")
public class MainLayout extends AppLayout {
    ...
    private Component createDrawerContent(Tabs menu) {
        ...
        logoLayout.add(new Image("images/logo.png", "Vaadin 14 app logo"));
        logoLayout.add(new H1("Vaadin 14 app"));
